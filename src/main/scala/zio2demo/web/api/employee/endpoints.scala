...
object EmployeeEndpoints {
  ...
  def get: Endpoint[java.util.UUID, java.util.UUID, ApplicationError, EmployeeResponse, AuthType.Bearer] =
  ...
  def getAll: Endpoint[Unit, Unit, ApplicationError, Vector[EmployeeResponse], AuthType.Bearer] =
  ...
  def insert: Endpoint[Unit, (java.util.UUID, EmployeeBody), ApplicationError, CreatedResponse, AuthType.Bearer] =
